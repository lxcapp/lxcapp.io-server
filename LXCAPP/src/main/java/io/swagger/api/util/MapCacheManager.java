...
public class MapCacheManager {
    ...
    private static Map<String, com.alibaba.fastjson.JSONObject> cacheMap = new ConcurrentHashMap<String, com.alibaba.fastjson.JSONObject>();// 缓存容器
     ...
     * @return
     */
    public Map<String, com.alibaba.fastjson.JSONObject> getMapCache() {
    ...
    public static void main(String[] args) {
        ...
        Map<String,  com.alibaba.fastjson.JSONObject> cacheMap = new ConcurrentHashMap<String,  com.alibaba.fastjson.JSONObject>();
